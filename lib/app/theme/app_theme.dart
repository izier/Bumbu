// ════════════════════════════════════════════════════════════════════════════
//  GRUB — FOOD ORDERING APP THEME
//  Inspired by: Behance Food Ordering Mobile App UI/UX Case Study
//  Brand Color: #FF383C
//  Design Language: Clean · Bold · Appetite-first · Photo-forward
// ════════════════════════════════════════════════════════════════════════════
...
class AppColors {
  ...
  // ── Bottom Nav (dark panel, as in design) ────────────────────────────────
...
class AppRadius {
  ...
  static const BorderRadius heroImageRadius = BorderRadius.all(Radius.circular(24));
  static const BorderRadius sheetRadius    = BorderRadius.vertical(top: Radius.circular(28));
}
  ...
  return ThemeData(
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: ButtonStyle(
        ...
        textStyle: WidgetStateProperty.all(AppTypography.buttonLarge.copyWith(
    ...
    // ── Typography override ────────────────────────────────────────────────
    textTheme: TextTheme(
      displayLarge:   AppTypography.heroTitle.copyWith(color: AppColors.textPrimary),
      ...
      titleSmall:     AppTypography.labelLarge.copyWith(color: AppColors.textPrimary),
...
ThemeData get appDarkTheme {
  return appLightTheme.copyWith(
    ...
    textTheme: TextTheme(
      displayLarge:   AppTypography.heroTitleLight.copyWith(color: AppColors.textPrimaryDark),
      displayMedium:  AppTypography.h1.copyWith(color: AppColors.textPrimaryDark),
      displaySmall:   AppTypography.h2.copyWith(color: AppColors.textPrimaryDark),
      headlineLarge:  AppTypography.h2.copyWith(color: AppColors.textPrimaryDark),
      headlineMedium: AppTypography.h3.copyWith(color: AppColors.textPrimaryDark),
      headlineSmall:  AppTypography.h4.copyWith(color: AppColors.textPrimaryDark),
...
class AppDecorations {
  ...
  // ── Bottom Nav Dark Panel (always dark — intentional per design) ──────────
  static const BoxDecoration navPanel = BoxDecoration(
  ...
  static BoxDecoration quantityStepper(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    return BoxDecoration(
      color: isDark ? AppColors.primaryDarker.withValues(alpha: 0.3) : AppColors.primarySurface,
      borderRadius: AppRadius.pillRadius,
    );
  }
...
// ─────────────────────────────────────────────────────────────────────────────
//  11. THEME EXTENSION — Custom tokens via ThemeExtension
// ─────────────────────────────────────────────────────────────────────────────
...
class AppThemeExtension extends ThemeExtension<AppThemeExtension> {
  ...
  AppThemeExtension copyWith({
    Color? cardColor, Color? surfaceAltColor, Color? starColor,
    Color? priceColor, Color? tagBg, Color? tagText,
    Color? deliveryBadgeBg, Color? deliveryBadgeText,
  }) {
  ...
  AppThemeExtension lerp(AppThemeExtension? other, double t) {
    ...
    return AppThemeExtension(
      ...
      deliveryBadgeText: Color.lerp(deliveryBadgeText, other.deliveryBadgeText, t)!,
    );
  }
}

// ─────────────────────────────────────────────────────────────────────────────
//  12. MAIN.DART INTEGRATION SNIPPET
// ─────────────────────────────────────────────────────────────────────────────
//
//  MaterialApp(
